...
export const register = createAsyncThunk('user/register', async (userform : IUserData) => {
    const response = await userApi.register(userform)
    return response;
});

export const login = createAsyncThunk('user/login', async (userform : IUserData) => {
...
export const changePass = createAsyncThunk('user/changePass', async (userform : IUserData) => {
    const response = await userApi.changePass(userform)
    return response;
});

export const changeInfor = createAsyncThunk('user/changeInfor', async (userform : string) => {
